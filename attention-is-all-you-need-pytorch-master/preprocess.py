...
def main_wo_bpe():
    """
    Usage: python preprocess.py -lang_src de_core_news_md -lang_trg en_core_web_md -save_data multi30k_de_en.pkl -share_vocab
    """
    ...
    # 加载训练好的语言模型
    src_lang_model = spacy.load('en_core_web_md')
    trg_lang_model = spacy.load('de_core_news_md')
    ...
    pad_token : 填充的 token
    lower     : 是否将文本转换为小写
    init_token: 序列开头填充的 token
    eos_token : 序列结尾填充的 token
    """
    ...
    # exts: 包含每种语言路径扩展名的tuple，这里就是.de和.en
